...
public class SendCode {
	...
	private static final String APP_KEY = "73919be186ae20a36953fa2d3de8dc76";
	// 网易云信分配的密钥，请替换你在管理后台应用下申请的appSecret
	private static final String APP_SECRET = "c019a163e598";
	// 随机数
	private static final String NONCE = "123456";
	// 短信模板ID
	private static final String TEMPLATEID = "14842668";
	// 手机号
	//private static  String MOBILE = "18917996024";
	// 验证码长度，范围4～10，默认为4
	...
	public  String phoneCode(String phone) throws Exception {
		...
		//把字符串转换为 JSON
		code=(String) JSON.parseObject(code).getString("obj");
		return code;
