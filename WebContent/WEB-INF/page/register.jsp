...
<body>
			...
			<div class="wrap">
				<div class="main clearfix">
					<div class="title">
						...
						<!--  <a href="./fastactive.html"><strong>激活账户</strong>ACTIVE USER</a> 
						|&nbsp; -->
						<a href="./fastregister.html"><strong>快速注册</strong>FAST REGSITER</a>
					</div>
					<!-- <form id="registerForm" method="post" novalidate="novalidate"> -->
						<table>
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20"> <span id="uname"></span>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="password" name="rePassword" id="enterpassword" class="text"
										maxlength="20" autocomplete="off"><span id="rrepassword"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200"><span id="remail"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>姓名:</th>
									<td><input type="text" name="name" id="rename"
										class="text" maxlength="200"><span id="rname"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField"></span>性别:</th>
									<td><span class="fieldSet"> <label> <input
												type="radio" name="sex" checked value="男">男
							...
							<%-- <tr>
								...
								<tr>
									<th>&nbsp;</th>
									<td><input id="btn" type="button" class="submit" value="同意以下协议并注册">
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
		...
		$.ajax({
			...
			success:function(result){
				if(result.error_code=="24"){ 
					tishi.innerHTML = "<font color='red' >此" + name + " 会员已存在！️</font>"
				}else{
					if(name==""){
						tishi.innerHTML = "<font color='red' > 用户名不能为空！️️</font>"
					}else{
			...
			$.ajax({
				...
				success:function(result){
					if(result.error_code=="24"){ 
						...
						if(name==""){
							tishi.innerHTML = "<font color='red' >邮箱不能为空！️️</font>"
						}else{
							tishi.innerHTML = "<font color='green' >√️️</font>"
						}	
					}			
	...
	$("#password").blur(function(){
		...
		var tishi2 = document.getElementById("rrepassword");
		var password = $("input[name='password']").val();
		var repassword = $("input[name='rePassword']").val();
		if(password==""){
	...
	$("#enterpassword").blur(function(){
		...
		var rename = $("input[name='name']").val();
		var tishi = document.getElementById("rname");
		if(rename==""){
			tishi.innerHTML = "<font color='red' >❌</font>"
		}else{
