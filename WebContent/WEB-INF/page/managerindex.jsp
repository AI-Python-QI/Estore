...
<!-- Graph CSS -->
<link href="${root }/css/lines.css" rel='stylesheet' type='text/css' />
...
<!-- Graph JavaScript -->
<script src="${root }/js/d3.v3.js"></script>
<script src="${root }/js/rickshaw.js"></script>
</head>
<body>
<div id="wrapper">
     <!-- Navigation -->
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="${root }/css/clndr.css" type="text/css" />
			<script src="${root }/js/underscore-min.js" type="text/javascript"></script>
			<script src= "${root }/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="js/clndr.js" type="text/javascript"></script>
			<script src="${root }/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="${root }/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="${root }/js/jquery.vmap.js"></script>
<script src="${root }/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="${root }/js/jquery.vmap.world.js" type="text/javascript"></script>
