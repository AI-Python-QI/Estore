...
<body id="login">
  <div class="login-logo">
   <%--  <a href="index.html"><img src="${root }/images/logo.png" alt=""/></a> --%>
  </div>
  <h2 class="form-heading">Estore商城管理系统</h2>
  <div class="app-cam">
	  <form>
   ...
   <div class="copy_layout login">
      <p>Copyright © 2020 Modern. All Rights Reserved | Design by <a href="http://h2design.taobao.com/" target="_blank">氢设计</a> </p>
   </div>
</body>
</html>